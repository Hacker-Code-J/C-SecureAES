...
/**
 * @file config.h
 * @brief Configuration settings for the AES encryption program.
 *
 * This header file contains global configuration settings and definitions
 * used throughout the AES encryption program. It includes key sizes,
 * block sizes, and other relevant settings.
 */
 ...
 *
 * Td0[x] = inv_s_box[x].[0e, 09, 0d, 0b]^T;
 * Td1[x] = inv_s_box[x].[0b, 0e, 09, 0d]^T;
 * Td2[x] = inv_s_box[x].[0d, 0b, 0e, 09]^T;
 * Td3[x] = inv_s_box[x].[09, 0d, 0b, 0e]^T;
 * Td4[x] = inv_s_box[x].[01];
*/
